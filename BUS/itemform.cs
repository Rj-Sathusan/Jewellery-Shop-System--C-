...
namespace Jewellery_System.BUS
{
    class itemform : DAT.NewDataAccessLayer
    {
        ...
        public itemform(int item_code, string item_name, int category_id, string categories, double item_amount, DateTime item_date, decimal item_weight, int item_carat, long shift_id)/*------Save, Edit Constructor----------*/
        {
        ...
        public itemform(string itemname)
      {
        ...
        public bool saveItem()
        {
            try
            {
                ...
                if (OpenConnection())
                {
                    if (ExecuteCommand("itemSave", param))
                    {
        ...
        public bool editItem()
        {
            try
            {
                ...
                if (OpenConnection())
                {
                    if (ExecuteCommand("ItemEdit", param))
                    {
